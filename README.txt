In order to run server.py, first, download MySQL and set it up. Set the username as root, host as the local host and password as "12345". 
Once done, open setup.py and run it to create all tables needed and the database. 

Once done with the setup.py, open the server.py and run it. Running the server.py file will allow you to use the website directly. 
